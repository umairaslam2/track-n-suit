...
export function AllProduct() {
  ...
  const handleUpdateProduct = async (updatedData) => {
    // console.log(`/single product id  /`,singleProduct.PRODUCT_ID)
    console.log("updatedData",updatedData.image)
    ...
    if (updatedData.image instanceof File) {
      // New image: append it as a file so that multer processes it
      formData.append("image", updatedData.image);
    } else {
      // Existing image: append it as a text field.
      // This will be available in req.body.image on the backend.
      formData.append("image", updatedData.image);
    }
    // formData.append("image", updatedData.image);
                        ...
                        <td className={`${classes} w-fit`}>
                          <div className="flex items-center gap-3">
                            <Avatar
                              ...
                              src={item.IMGURL?.length != 0 ? item.IMGURL : "/Images/Img-not-found.jpg"}
