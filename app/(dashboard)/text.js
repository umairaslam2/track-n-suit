        ...
        <div className="grid lg:grid-cols-2 justify-center items-center gap-10">
          <div>
            ...
            <p className="text-base leading-relaxed">
              Unlock the potential of your business with advanced analysis tools
              that provide insightful strategies. Our cutting-edge analytics
              empower you to make informed decisions and strategically scale
              your business.
            </p>
        ...
        <div className="grid md:grid-cols-2 items-center gap-10">
          ...
          <div>
            ...
            <p>
              ...
              Lorem minim. Officia do aliqua adipisicing ullamco in. anim
              excepteur et ex consectetur velit ullamco veniam minim aute sit.
            </p>
            <div className="mt-8">
    ...
    <div className="mt-28 px-4 sm:px-10 bg-blue-100">
      <div className="min-h-[400px] relative h-full max-w-2xl mx-auto flex flex-col justify-center items-center text-center px-6 py-16">
        ...
        <p>
          ...
          minim. Officia do aliqua adipisicing ullamco in. consectetur velit
