...
import { LoginSuccess } from "@/GlobalRedux/Slices/UserSlice";
      ...
      <div className="rounded-3xl border border-stroke w-full h-[80vh]   bg-[#e6e8eb] flex items-center justify-center shadow-lg shadow-gray-500">
        ...
        className="flex flex-wrap items-center justify-center w-full h-full ">
          <div className="hidden w-full xl:block xl:w-1/2">
            ...
            <Link href={"/"}>
          <span className="lg:flex items-center justify-start px-10 pb-8 hidden text-blue-400 font-bold hover:underline hover:cursor-pointer"> <IoArrowBackOutline size={30} /> </span>
          </Link>
